...
def test_solution_part2_invalid():
...
pid:3556412378 byr:2007"""
    ...
    assert 0 == ret
    print(f'Test succeeded: 0 == {ret}')

def test_solution_part2_valid():
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719"""
    ...
    ret = solution_part2(input)
    assert 4 == ret
    print(f'Test succeeded: 4 == {ret}')

if __name__ == '__main__':
    test_solution_part1()
    test_solution_part2_invalid()
    test_solution_part2_valid()
